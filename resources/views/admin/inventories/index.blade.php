...
<div class="flex justify-between items-center mb-8">
    <h1 class="text-3xl">Kelola Inventaris</h1>
    <a href="{{ route('admin.inventories.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus mr-2"></i> Tambah Barang</a>
</div>
        ...
        <table style="width: 100%; border-collapse: collapse; text-align: left;">
            <thead>
                <tr style="border-bottom: 1px solid var(--border);">
                    ...
                    <th style="padding: 1rem; color: var(--text-muted); font-weight: 500;">Nama Barang</th>
                    <th style="padding: 1rem; color: var(--text-muted); font-weight: 500;">Harga Sewa</th>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border);">
                    ...
                    <td style="padding: 1rem;">
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('admin.inventories.edit', $inventory) }}" class="btn btn-outline" style="padding: 0.25rem 0.75rem; font-size: 0.875rem;" title="Edit"><i class="fa-solid fa-pen"></i></a>
                            <form action="{{ route('admin.inventories.destroy', $inventory) }}" method="POST" onsubmit="return confirm('Hapus barang ini?');">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="4" style="padding: 1rem; text-align: center; color: var(--text-muted);">Belum ada data inventaris.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
