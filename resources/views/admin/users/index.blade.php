...
<div class="flex justify-between items-center mb-8">
    <h1 class="text-3xl">Kelola Pengguna & Admin</h1>
    <a href="{{ route('admin.users.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus mr-2"></i> Tambah Admin</a>
</div>
...
<div class="card mb-6" style="background-color: var(--background); border: 1px solid var(--border); box-shadow: none;">
    <form action="{{ route('admin.users.index') }}" method="GET" class="flex flex-wrap gap-4 items-end">
        <div class="form-group mb-0" style="flex: 1; min-width: 250px;">
            <label class="form-label text-sm">Cari (Nama atau Email)</label>
        ...
        <div class="form-group mb-0" style="width: 200px;">
            <label class="form-label text-sm">Role Pengguna</label>
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border);">
                    ...
                    <td style="padding: 1rem;">
                        <div class="flex gap-2">
                            @if($u->role === 'admin')
                                <a href="{{ route('admin.users.edit', $u) }}" class="btn btn-outline" style="padding: 0.25rem 0.75rem; font-size: 0.875rem;"><i class="fa-solid fa-pen"></i> Edit</a>
                            @endif
                ...
                @empty
                <tr>
                    <td colspan="5" style="padding: 1rem; text-align: center; color: var(--text-muted);">Belum ada data pengguna.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
