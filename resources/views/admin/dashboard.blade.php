    ...
    <h1 class="text-3xl">Dashboard Overview</h1>
        ...
        <div class="grid grid-cols-4 gap-6 mb-8">
            <div class="card stat-card">
                <div>
                    <h3 class="text-muted text-sm uppercase mb-2" style="font-weight: 500; font-size: 0.75rem; letter-spacing: 0.05em;">Total Reservasi</h3>
            ...
            <div class="card stat-card">
                <div>
                    <h3 class="text-muted text-sm uppercase mb-2" style="font-weight: 500; font-size: 0.75rem; letter-spacing: 0.05em;">Pendapatan Total</h3>
            ...
            <div class="card stat-card">
                <div>
                    <h3 class="text-muted text-sm uppercase mb-2" style="font-weight: 500; font-size: 0.75rem; letter-spacing: 0.05em;">Total Pengguna</h3>
            ...
            <div class="card stat-card">
                <div>
                    <h3 class="text-muted text-sm uppercase mb-2" style="font-weight: 500; font-size: 0.75rem; letter-spacing: 0.05em;">Lapangan Tersedia</h3>
        ...
        <!-- Quick Actions Panel -->
        <h3 class="text-xl mb-4 font-semibold" style="margin-top: 1rem;">Pintasan Cepat</h3>
        <div class="shortcuts-grid mb-8">
            <a href="{{ route('admin.courts.create') }}" class="card shortcut-card">
                <div class="stat-icon" style="background-color: rgba(37, 99, 235, 0.1); color: var(--primary);">
                    <i class="fa-solid fa-square-plus"></i>
                </div>
                <span class="text-sm font-medium" style="color: var(--text-main); margin-top: 0.25rem;">Tambah Lapangan</span>
            </a>
            <a href="{{ route('admin.coaches.create') }}" class="card shortcut-card">
                <div class="stat-icon" style="background-color: rgba(139, 92, 246, 0.1); color: #8b5cf6;">
                    <i class="fa-solid fa-user-plus"></i>
                </div>
                <span class="text-sm font-medium" style="color: var(--text-main); margin-top: 0.25rem;">Tambah Coach</span>
            </a>
            <a href="{{ route('admin.reservations.index') }}" class="card shortcut-card">
                <div class="stat-icon" style="background-color: rgba(16, 185, 129, 0.1); color: #10b981;">
                    <i class="fa-solid fa-calendar-days"></i>
                </div>
                <span class="text-sm font-medium" style="color: var(--text-main); margin-top: 0.25rem;">Kelola Reservasi</span>
            </a>
            <a href="{{ route('admin.announcements.create') }}" class="card shortcut-card">
                ...
                <span class="text-sm font-medium" style="color: var(--text-main); margin-top: 0.25rem;">Buat Pengumuman</span>
            </a>
            <a href="{{ route('admin.discounts.index') }}" class="card shortcut-card">
                <div class="stat-icon" style="background-color: rgba(245, 158, 11, 0.1); color: #f59e0b;">
                    <i class="fa-solid fa-tags"></i>
                </div>
                <span class="text-sm font-medium" style="color: var(--text-main); margin-top: 0.25rem;">Kelola Diskon</span>
            </a>
            <a href="{{ route('admin.backup.index') }}" class="card shortcut-card">
                ...
                <span class="text-sm font-medium" style="color: var(--text-main); margin-top: 0.25rem;">Backup & Restore</span>
            </a>
        </div>
        ...
        <div class="dashboard-grid mb-8">
            ...
            <div class="card col-span-2">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl" style="font-weight: 600;">Tren Reservasi (7 Hari Terakhir)</h3>
                    <span class="badge" style="background-color: rgba(37, 99, 235, 0.1); color: var(--primary); padding: 0.25rem 0.75rem; border-radius: var(--radius-md); font-size: 0.75rem; font-weight: 600;">Harian</span>
                </div>
            ...
            <div class="card col-span-1">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl" style="font-weight: 600;">Popularitas Lapangan</h3>
                </div>
        ...
        <div class="dashboard-grid mb-8">
            ...
            <div class="card col-span-2">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl" style="font-weight: 600;">Tren Pendapatan Bulanan (6 Bulan Terakhir)</h3>
                    <span class="badge" style="background-color: rgba(16, 185, 129, 0.1); color: #10b981; padding: 0.25rem 0.75rem; border-radius: var(--radius-md); font-size: 0.75rem; font-weight: 600;">Finansial</span>
                </div>
                <div style="position: relative; height: 320px; width: 100%;">
            ...
            <div class="card col-span-1">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl" style="font-weight: 600;">Jam Booking Terpopuler</h3>
                </div>
