...
<div class="flex justify-between items-center mb-8">
    ...
    <a href="{{ route('admin.discounts.create') }}" class="btn btn-primary"><i class="fa-solid fa-plus mr-2"></i> Tambah Diskon</a>
</div>
    ...
    <div style="overflow-x: auto;">
        <table style="width: 100%; border-collapse: collapse; text-align: left;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border);">
                    ...
                    <td style="padding: 1rem;">
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('admin.discounts.destroy', $discount) }}" method="POST" onsubmit="return confirm('Hapus diskon ini?');">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="5" style="padding: 1rem; text-align: center; color: var(--text-muted);">Belum ada data diskon.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
